...
with open('FullData_3/LOG_K_Varianti.csv','r') as SM:
	ListByK_3 = [[],[],[],[]]
	for line in SM:
		t = line
		temp = t.split(",")
...
with open('FullData_3/K_varianti_plot','w') as WR:
	...
	for k_3 in range(0,len(ListByK_3)):
		...
		WR.write('\\caption{TP al variare della dimensione del vicinato $k_1$ su $k_3$ = '+ str(k_3 + 1) + ' estrazioni per utente e $30\%$ di test set con '+ str(ListByK_3[k_3][0][3]) +' righe scartate.} \n')
		WR.write('\\end{figure} \n')
		WR.write('\n')
		WR.write('\n')		
		WR.write('\n')
